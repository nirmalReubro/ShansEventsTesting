...
export class RentalsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.rentalService.getItems();
    this.itemsSub = this.rentalService.getItemUpdateListener()
  ...
  onConfirm() {
    ...
    localStorage.setItem('transactionType', 'Rental');
