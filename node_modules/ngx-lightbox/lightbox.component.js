...
var LightboxComponent = /** @class */ (function () {
    ...
    /**
       * Fire when the image is loaded
       */
    LightboxComponent.prototype._onLoadImageSuccess = /**
       * Fire when the image is loaded
       */
    function () {
        if (!this.options.disableKeyboardNav) {
    ...
    /**
       * addCssAnimation add css3 classes for animate lightbox
       */
    LightboxComponent.prototype._addCssAnimation = /**
       * addCssAnimation add css3 classes for animate lightbox
       */
    function () {
    ...
    LightboxComponent.propDecorators = {
        "album": [{ type: core_1.Input },],
        "currentImageIndex": [{ type: core_1.Input },],
        "options": [{ type: core_1.Input },],
        "cmpRef": [{ type: core_1.Input },],
        "_outerContainerElem": [{ type: core_1.ViewChild, args: ['outerContainer',] },],
        "_containerElem": [{ type: core_1.ViewChild, args: ['container',] },],
        "_leftArrowElem": [{ type: core_1.ViewChild, args: ['leftArrow',] },],
        "_rightArrowElem": [{ type: core_1.ViewChild, args: ['rightArrow',] },],
        "_navArrowElem": [{ type: core_1.ViewChild, args: ['navArrow',] },],
        "_dataContainerElem": [{ type: core_1.ViewChild, args: ['dataContainer',] },],
        "_imageElem": [{ type: core_1.ViewChild, args: ['image',] },],
        "_captionElem": [{ type: core_1.ViewChild, args: ['caption',] },],
        "_numberElem": [{ type: core_1.ViewChild, args: ['number',] },],
    };
